...
urlpatterns = [
    ...
    path(
        "summary-by-gene.js", views.SummaryByGeneJS.as_view(), name="summary_by_gene_js"
    ),
    path(
        "full-summary-by-gene.js",
        views.FullSummaryByGeneJS.as_view(),
        name="full_summary_by_gene_js",
    ),
