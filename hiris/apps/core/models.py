...
class CoreBaseModel(models.Model):
    ...
    def name(self) -> str:
        ...
        if hasattr(self, "name_field") and self.name_field:  # type: ignore
            ...
            name_list: list[str] = re.sub(
                r"([A-Z])", r" \1", self.__class__.__name__
            ).split()
...
class GenomeSpecies(CoreBaseModel):
    ...
    genome_species_name = models.CharField(
        "Name of the species.", max_length=255, unique=True
    )
...
class GenomeVersion(CoreBaseModel):
    ...
    genome_species = models.ForeignKey(
        GenomeSpecies, on_delete=models.CASCADE, related_name="versions"
    )
...
class Feature(CoreBaseModel):
    ...
    genome_version = models.ForeignKey(
        GenomeVersion, on_delete=models.CASCADE, related_name="features"
    )
    feature_name = models.CharField(max_length=255, null=True)
    external_gene_id = models.IntegerField(null=True, blank=True)
    feature_type = models.ForeignKey(
        FeatureType, on_delete=models.CASCADE, null=False, related_name="features"
    )
    gene_type = models.ForeignKey(
        GeneType, on_delete=models.CASCADE, null=True, related_name="features"
    )
...
class FeatureLocation(CoreBaseModel):
    ...
    feature = models.ForeignKey(
        Feature, on_delete=models.CASCADE, related_name="feature_locations"
    )
    ...
    feature_orientation = models.CharField(
        max_length=1, choices=(("F", "Forward"), ("R", "Reverse")), null=False
    )
...
class DataSet(CoreBaseModel):
    ...
    genome_version = models.ForeignKey(
        GenomeVersion, on_delete=models.CASCADE, related_name="data_sets"
    )
...
class DataSetSource(CoreBaseModel):
    ...
    data_set = models.ForeignKey(
        DataSet, on_delete=models.CASCADE, related_name="data_set_sources"
    )
    ...
    document_citation_issue_number = models.CharField(
...
class Publication(CoreBaseModel):
    ...
    data_set = models.ForeignKey(
        DataSet, on_delete=models.CASCADE, related_name="publications"
    )
...
class PublicationData(CoreBaseModel):
    ...
    publication = models.ForeignKey(
        Publication, on_delete=models.CASCADE, related_name="publication_data"
    )
...
class Subject(CoreBaseModel):
    ...
    publication = models.ForeignKey(
        Publication, on_delete=models.CASCADE, related_name="subjects"
    )
...
class Sample(CoreBaseModel):
    ...
    subject = models.ForeignKey(
        Subject, on_delete=models.CASCADE, related_name="samples"
    )
...
class SampleData(CoreBaseModel):
    ...
    sample = models.ForeignKey(
        Sample, on_delete=models.CASCADE, related_name="sample_data"
    )
    key = models.CharField(max_length=255, null=False, blank=False)
...
class Preparation(CoreBaseModel):
    ...
    sample = models.ForeignKey(
        Sample, on_delete=models.CASCADE, related_name="preparations"
    )
...
class SequencingMethod(CoreBaseModel):
    ...
    preparation = models.ForeignKey(
        Preparation, on_delete=models.CASCADE, related_name="sequencing_methods"
    )
...
class Integration(CoreBaseModel):
    ...
    integration_environment = models.ForeignKey(
    ...
    sequencing_method = models.ForeignKey(
        SequencingMethod, on_delete=models.CASCADE, related_name="integrations"
    )
    integration_name = models.CharField(max_length=255, null=True, blank=True)
    ltr = models.CharField(
        max_length=2, choices=(("3p", "3p"), ("5p", "5p")), null=True
    )
...
class IntegrationLocation(CoreBaseModel):
    ...
    integration = models.ForeignKey(
        Integration, on_delete=models.CASCADE, related_name="integration_locations"
    )
    feature_locations = models.ManyToManyField(
        FeatureLocation,
        related_name="integration_locations",
        through="IntegrationFeature",
        editable=False,
    )
    ...
    orientation_in_landmark = models.CharField(
        max_length=1, choices=(("F", "Forward"), ("R", "Reverse")), null=True
    )
...
class IntegrationFeature(CoreBaseModel):
    ...
    integration_location = models.ForeignKey(
        IntegrationLocation, on_delete=models.DO_NOTHING
    )
...
class BlastInfo(CoreBaseModel):
    ...
    integration_location = models.OneToOneField(
        IntegrationLocation, on_delete=models.CASCADE, related_name="blast_info"
    )
...
class LandmarkChromosome(CoreBaseModel):
    ...
    genome_version = models.ForeignKey(
        GenomeVersion, on_delete=models.CASCADE, related_name="landmark_chromosomes"
    )
    landmark = models.CharField(max_length=255)
