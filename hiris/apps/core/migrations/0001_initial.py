    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject_identifier', models.CharField(blank=True, max_length=255, null=True)),
                ('data_set', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='core.dataset')),
            ],
            options={
                'db_table': 'subjects',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='integrations', to='core.sequencingmethod'),
        ),
        migrations.CreateModel(
            name='GenomeVersion',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('added', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('blast_info_id', models.BigAutoField(editable=False, primary_key=True, serialize=False)),
                ...
                ('integration_location', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.integrationlocation')),
            ],
            options={
                'db_table': 'blast_info',
            },
