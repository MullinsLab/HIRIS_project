    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="core.IntegrationFeature",
                to="core.featurelocation",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["integration_location"], name="integration_integra_b01cff_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="integrationfeature",
            index=models.Index(
                fields=["feature_location"], name="integration_feature_29e154_idx"
            ),
        ),
