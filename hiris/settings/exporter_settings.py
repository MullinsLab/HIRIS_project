            ...
            "apps": [
                {
                    ...
                    "models": {
                        "Integration": {"dont_link_to": ["DataSet"]},
                        "DataSet": {"dont_link_to": ["GenomeVersion"]},
                    },
                }
            ],
        },
            ...
            "rollups": [
                {
                    ...
                    "group_by": [
                        ...
                        "subject_identifier",
                        "core.IntegrationFeature.feature_type_name",
                        "core.IntegrationLocation.landmark",
                        "location",
                        "orientation_in_landmark",
                        "feature_orientation",
                        "orientation_in_feature",
                        "gene_type_name",
                        "feature_name",
                        "external_gene_id",
                    ],
                    "extra_field": [
                        {"column_name": "multiplicity", "function": "count"}
                    ],
                },
            ],
        },
