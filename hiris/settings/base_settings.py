...
MIDDLEWARE = list(
    filter(
        ...
        [
            ...
            "hiris.middleware.AddHTTP_X_FORWARDED_PORTMiddleware"
            if LOGIN_TYPE in ("dual", "sso") and EXTERNAL_WEB_PORT
            else None,
        ],
    )
)
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(BASE_DIR, "hiris/templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
CSRF_TRUSTED_ORIGINS = [
    "http://localhost",
    "https://dev.hiris.washington.edu",
    "https://idp.u.washington.edu",
]
...
logging.config.dictConfig(
    {
        ...
        "root": {"handlers": ["console", "requests.log"], "level": LOGLEVEL},
        "formatters": {
            "verbose": {
