    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="files",
                        to="ml_import_wizard.importscheme",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "errors",
                    models.JSONField(
                        verbose_name="Why was this row rejected by the importer?"
                    ),
                ),
                (
                    "row",
                    models.JSONField(
                        verbose_name="Complete data for the row that was rejected"
                    ),
                ),
                (
                    "import_scheme",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="fields",
                        to="ml_import_wizard.importschemefile",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="files",
                to="ml_import_wizard.importschemefilestatus",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="ml_import_wizard.importschemestatus",
            ),
        ),
        migrations.AddField(
            model_name="importscheme",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "app",
                    models.CharField(
                        max_length=255, verbose_name="App this import item is for"
                    ),
                ),
                (
                    "model",
                    models.CharField(
                        max_length=255, verbose_name="Model this import item is for"
                    ),
                ),
                (
                    "field",
                    models.CharField(
                        max_length=255, verbose_name="DB Field this import item is for"
                    ),
                ),
                (
                    "strategy",
                    models.CharField(
                        max_length=255,
                        null=True,
                        verbose_name="Strategy for doing this import",
                    ),
                ),
                (
                    "settings",
                    models.JSONField(
                        default=dict, verbose_name="Settings specific to this import"
                    ),
                ),
