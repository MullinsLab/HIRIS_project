    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, 'New'), (1, 'Files Received'), (2, 'Import Defined'), (3, 'Data Previewed'), (4, 'Import Started'), (5, 'Import Completed')], default=0)),
