...
from ml_import_wizard.views import ManageImports, NewImportScheme, DoImportScheme, DoImportSchemeItem, ListImportSchemeItems, DoImporterField
...
urlpatterns = [
    ...
    path('<int:import_scheme_id>/<str:field_name>', DoImporterField.as_view(), name='importer_field'),
